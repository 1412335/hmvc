                    ...
                    <div class="col-md-12">
                        <form action="" method="post" id="form-slide" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="slide_title" id="slide_title" placeholder="Enter Slide title">
                            </div>
                            <div class="form-group">
                                <label for="slide_url">Slide URL</label>
                                <input type="text" class="form-control" name="slide_url" id="slide_url" placeholder="Enter URL">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <img src="{$base_url}uploads/slides/default.jpg" id="slide_img_preview" height="200" class="img-preview img-responsive img-bordered" style="margin: auto;">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary btn-flat" id="add" name="add">Save</button>
                        </form>
                    </div>
                </div>
            </div>
